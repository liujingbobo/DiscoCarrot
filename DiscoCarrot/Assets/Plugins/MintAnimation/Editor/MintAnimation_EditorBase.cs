...
namespace MintAnimation.Editor
{
    ...
    public class MintAnimation_EditorBase : UnityEditor.Editor
    {
        ...
        protected SerializedProperty ResetValueOnEnable;
        protected SerializedProperty FinalizeValueOnDisable;
        ...
        protected virtual void Init()
        {
            ...
            ResetValueOnEnable = this.serializedObject.FindProperty("ResetValueOnEnable");
            FinalizeValueOnDisable = this.serializedObject.FindProperty("FinalizeValueOnDisable");
        ...
        public virtual void Draw()
        {
            ...
            if (this.foldoutType)
            {
                ...
                EditorGUILayout.PropertyField(ResetValueOnEnable);
                EditorGUILayout.PropertyField(FinalizeValueOnDisable);
                GUILayout.Box(GUIContent.none, GUILayout.ExpandWidth(true), GUILayout.Height(0.5f));
