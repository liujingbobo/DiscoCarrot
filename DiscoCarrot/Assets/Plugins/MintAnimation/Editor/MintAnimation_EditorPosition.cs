...
namespace MintAnimation.Editor
{
    ...
    public class MintAnimation_EditorPosition : MintAnimation_EditorBase
    {
        ...
        private SerializedProperty justY;
        private SerializedProperty justX;
        ...
        protected override void Init()
        {
            ...
            justY = serializedObject.FindProperty("justY");
            justX = serializedObject.FindProperty("justX");
        }
        ...
        public override void Draw()
        {
            ...
            EditorGUILayout.PropertyField(this.justY);
            EditorGUILayout.PropertyField(this.justX);
            GUILayout.Space(10);
